	...
	$.getJSON(api_url+'tickets/list_all?callback=?', {offset:local_offset}, function(data){
		if(data.status=='success'){
			...
			if(data.data.tickets.length==0){
				$('#main').append('<div class="notice full animated fadeInDown"><div class="icon"><i class="fa fa-smile-o"></i></div><div class="text">En este momento no tienes incidencias abiertas</div></div>');
			}
		}
