				...
				$.get(''+options.xmlUrl+'', function(d){
					$(d).find('event').each(function(){
						...
						function multidaylist(){
							if(eventColor==''){
							    $('#'+uniqueId+' .monthly-list-item[data-number="'+i+'"]').addClass('item-has-event').append('<div class="listed-event"  data-eventid="'+ eventId +'" style="padding-top:0px; overflow:auto;"><div style="margin-top: 0px; overflow: auto; width: -moz-max-content; float: left;"><div style="margin-top: 0px; overflow: auto; width: -moz-max-content; float: left;"><span onclick="showHorario('+eventId+');" style="min-width: 165px; overflow: auto; margin-right: 14px; cursor: pointer; float: left; clear: both; display: block;">'+eventTitle+'</span><div style="overflow: auto; float: left; clear: left;"><div class="monthly-list-time-start">'+startTime+' '+startPeriod+'</div><div class="monthly-list-time-end">'+endTime+' '+endPeriod+'</div></div></div><div style="overflow: auto; width: 400px; float: left;"><i onclick="deleteHorario('+eventId+');" class="fa fa-trash-o" style="cursor:pointer; font-size: 35px; margin-top: 3px; float: left;"></i><div style="overflow: auto; width: 200px; float: left;"><span style="font-size: 11px; font-weight: 600; text-transform: uppercase; display: block; float: left; padding-top: 3px; margin-left: 20px; '+colordis+'">Plazas disponibles: '+eventDis+'</span><span style="font-size: 11px; font-weight: 600; text-transform: uppercase; display: block; float: left; margin-left: 20px; '+colorcola+'">Plazas en la cola: '+eventDisCol+'</span></div><div style="overflow: auto; width: 140px; float: left; margin-top: 2px;"><span style="font-size: 13px; display: block; float: left; margin-left: 20px; color: black;">Aforo: '+eventAf+'</span><span style="font-size: 13px; display: block; float: left; margin-left: 20px; color: black;">Aforo de la cola: '+eventAfcol+'</span></div></div></div>');
							}
						...
						if (!fullendDate && startMonth == setMonth && startYear == setYear) {
							...
							$('#'+uniqueId+' .monthly-list-item[data-number="'+startDay+'"]').addClass('item-has-event').append('<div class="listed-event"  data-eventid="'+ eventId +'" style="padding-top:0px; overflow:auto;"><div style="margin-top: 0px; overflow: auto; width: -moz-max-content; float: left;"><div style="margin-top: 0px; overflow: auto; width: -moz-max-content; float: left;"><span onclick="showHorario('+eventId+');" style="min-width: 165px; overflow: auto; margin-right: 14px; cursor: pointer; float: left; clear: both; display: block;">'+eventTitle+'</span><div style="overflow: auto; float: left; clear: left;"><div class="monthly-list-time-start">'+startTime+' '+startPeriod+'</div><div class="monthly-list-time-end">'+endTime+' '+endPeriod+'</div></div></div><div style="overflow: auto; width: 400px; float: left;"><i onclick="deleteHorario('+eventId+');" class="fa fa-trash-o" style="cursor:pointer; font-size: 35px; margin-top: 3px; float: left;"></i><div style="overflow: auto; width: 200px; float: left;"><span style="font-size: 11px; font-weight: 600; text-transform: uppercase; display: block; float: left; padding-top: 3px; margin-left: 20px; '+colordis+'">Plazas disponibles: '+eventDis+'</span><span style="font-size: 11px; font-weight: 600; text-transform: uppercase; display: block; float: left; margin-left: 20px; '+colorcola+'">Plazas en la cola: '+eventDisCol+'</span></div><div style="overflow: auto; width: 140px; float: left; margin-top: 2px;"><span style="font-size: 13px; display: block; float: left; margin-left: 20px; color: black;">Aforo: '+eventAf+'</span><span style="font-size: 13px; display: block; float: left; margin-left: 20px; color: black;">Aforo de la cola: '+eventAfcol+'</span></div></div></div>');
