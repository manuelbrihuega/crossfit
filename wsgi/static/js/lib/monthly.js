				...
				$.get(''+options.xmlUrl+'', function(d){
					$(d).find('event').each(function(){
						...
						function multidaylist(){
							$('#'+uniqueId+' .monthly-list-item[data-number="'+i+'"]').addClass('item-has-event').append('<div class="listed-event"  data-eventid="'+ eventId +'" style="padding-top:0px;"><span onclick="showHorario('+eventId+');" style="float: left; overflow: auto; margin-right: 14px; cursor:pointer;">'+eventTitle+'</span><div style="overflow:auto; width:400px;"><i onclick="deleteHorario('+eventId+');" class="fa fa-trash-o" style="cursor:pointer; font-size: 35px; margin-top: 3px; float: left;"></i><div style="overflow: auto; width: 200px; float: left;"><span style="font-size: 13px; display: block; float: left; padding-top: 3px; margin-left: 20px; color: green;">Plazas disponibles: '+eventDis+'</span><span style="font-size: 13px; display: block; float: left; margin-left: 20px; color: red;">Plazas ocupadas: '+eventOc+'</span></div><div style="overflow: auto; width: 140px; float: left; margin-top: 2px;"><span style="font-size: 13px; display: block; float: left; margin-left: 20px; color: black;">Aforo: '+eventAf+'</span><span style="font-size: 13px; display: block; float: left; margin-left: 20px; color: black;">Aforo de la cola: '+eventAfcol+'</span></div></div><div style="width: auto; float: none; margin-top: -17px;"><div class="monthly-list-time-start">'+startTime+' '+startPeriod+'</div><div class="monthly-list-time-end">'+endTime+' '+endPeriod+'</div></div></div>');
						}
