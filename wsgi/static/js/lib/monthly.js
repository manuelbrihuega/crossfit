				...
				$.get(''+options.xmlUrl+'', function(d){
					$(d).find('event').each(function(){
						...
						function multidaylist(){
							if(eventColor==''){
							    $('#'+uniqueId+' .monthly-list-item[data-number="'+i+'"]').addClass('item-has-event').append('<div class="listed-event"  data-eventid="'+ eventId +'" style="background-color: lightgray; padding-top:0px; overflow:auto; border: 1px solid lightgray; border-radius: 7px; margin-left: auto; margin-right: auto; width:100%;"><div style="margin-top: 0px; overflow: auto; width: -moz-max-content; float: left;"><i onclick="deleteHorario('+eventId+');" class="fa fa-trash-o" style="cursor:pointer; font-size: 35px; margin-top: 3px; float: left; margin-right: 11px;"></i><div id="contentActivity" style="margin-top: 0px; overflow: auto; width: -moz-max-content; float: left;"><span onclick="showHorario('+eventId+');" style="min-width: 165px; overflow: auto; margin-right: 14px; cursor: pointer; float: left; clear: both; display: block;">'+eventTitle+'</span><div style="overflow: auto; float: left; clear: left;"><div class="monthly-list-time-start">'+startTime+' '+startPeriod+'</div><div class="monthly-list-time-end">'+endTime+' '+endPeriod+'</div></div></div><div id="contentActions" style="overflow: auto; width: 400px; float: left;"><div id="contentPlazas" style="overflow: auto; width: 200px;"><span style="font-size: 11px; font-weight: 600; text-transform: uppercase; display: block; float: left; padding-top: 3px; margin-left: 0px; '+colordis+'">Plazas disponibles: '+eventDis+'</span><span style="font-size: 11px; font-weight: 600; text-transform: uppercase; display: block; float: left; margin-left: 0px; '+colorcola+'">Plazas en la cola: '+eventDisCol+'</span></div><div id="contentAforo" style="overflow: auto; width: 140px; float: left; margin-top: 1px;"><span style="font-size: 11px; display: block; float: left; margin-left: 0px; color: black;">Aforo: '+eventAf+'</span><span style="font-size: 13px; display: block; float: left; margin-left: 0px; color: black;">Aforo de la cola: '+eventAfcol+'</span></div></div></div>');
							}
						}
						...
						if (!fullendDate && startMonth == setMonth && startYear == setYear) {
							...
							$('#'+uniqueId+' .monthly-list-item[data-number="'+startDay+'"]').addClass('item-has-event').append('<div class="listed-event"  data-eventid="'+ eventId +'" style="background-color: lightgray; padding-top:0px; overflow:auto; border: 1px solid lightgray; border-radius: 7px; margin-left: auto; margin-right: auto; width:100%;"><div style="margin-top: 0px; overflow: auto; width: -moz-max-content; float: left;"><i onclick="deleteHorario('+eventId+');" class="fa fa-trash-o" style="cursor:pointer; font-size: 35px; margin-top: 3px; float: left; margin-right: 11px;"></i><div id="contentActivity" style="margin-top: 0px; overflow: auto; width: -moz-max-content; float: left;"><span onclick="showHorario('+eventId+');" style="min-width: 165px; overflow: auto; margin-right: 14px; cursor: pointer; float: left; clear: both; display: block;">'+eventTitle+'</span><div style="overflow: auto; float: left; clear: left;"><div class="monthly-list-time-start">'+startTime+' '+startPeriod+'</div><div class="monthly-list-time-end">'+endTime+' '+endPeriod+'</div></div></div><div id="contentActions" style="overflow: auto; width: 400px; float: left;"><div id="contentPlazas" style="overflow: auto; width: 200px;"><span style="font-size: 11px; font-weight: 600; text-transform: uppercase; display: block; float: left; padding-top: 3px; margin-left: 0px; '+colordis+'">Plazas disponibles: '+eventDis+'</span><span style="font-size: 11px; font-weight: 600; text-transform: uppercase; display: block; float: left; margin-left: 0px; '+colorcola+'">Plazas en la cola: '+eventDisCol+'</span></div><div id="contentAforo" style="overflow: auto; width: 140px; float: left; margin-top: 1px;"><span style="font-size: 13px; display: block; float: left; margin-left: 0px; color: black;">Aforo: '+eventAf+'</span><span style="font-size: 13px; display: block; float: left; margin-left: 0px; color: black;">Aforo de la cola: '+eventAfcol+'</span></div></div></div>');
