			...
			if (options.mode == 'event') {
				...
				$.get(''+options.xmlUrl+'', function(d){
					$(d).find('event').each(function(){
						...
						var cadaction = '';
						if(eventYa=='SI'){
							cadaction = '<i onclick="deleteMiReserva('+eventId+');" class="fa fa-ban" style="cursor:pointer; font-size: 35px; margin-top: 3px; float: left;"></i>';
							if(eventPcan=='NO'){
								cadaction = '';
							}
						}
						if(eventYa=='NO'){
							cadaction = '<i onclick="addReservaCliente('+eventId+');" class="fa fa-plus-square" style="cursor:pointer; font-size: 35px; margin-top: 3px; float: left;"></i>';
							if(eventPres=='NO'){
								cadaction = '';
							}
						}
						function multidaylist(){
							if(eventColor==''){
							    $('#'+uniqueId+' .monthly-list-item[data-number="'+i+'"]').addClass('item-has-event').append('<div class="listed-event"  data-eventid="'+ eventId +'" style="'+backgr+' border: 1px solid lightgray; border-radius: 7px; margin-left: auto; margin-right: auto; overflow: auto; padding-top: 0; width: 100%;"><div style="margin-top: 0px; overflow: auto; width: -moz-max-content; float: left;"><div id="contentActivity" style="margin-top: 0px; overflow: auto; width: -moz-max-content; float: left;"><span style="min-width: 165px; overflow: auto; margin-right: 14px; cursor: pointer; float: left; clear: both; display: block;">'+eventTitle+'</span><div style="overflow: auto; float: left; clear: left;"><div class="monthly-list-time-start">'+startTime+' '+startPeriod+'</div><div class="monthly-list-time-end">'+endTime+' '+endPeriod+'</div></div></div><div id="contentActions" style="overflow: auto; width: 400px; float: left;">'+cadaction+'<div id="contentPlazas" style="overflow: auto; width: 200px;"><span style="font-size: 11px; font-weight: 600; text-transform: uppercase; display: block; float: left; padding-top: 3px; margin-left: 20px; '+colordis+'">Plazas disponibles: '+eventDis+'</span><span style="font-size: 11px; font-weight: 600; text-transform: uppercase; display: block; float: left; margin-left: 20px; '+colorcola+'">Plazas en la cola: '+eventDisCol+'</span></div><div id="contentAforo" style="overflow: auto; width: 140px; float: left; margin-top: 1px;"><span style="font-size: 11px; text-transform: uppercase; padding-top: 2px; display: block; float: left; margin-left: 20px; '+coloraforo+'">Aforo: '+eventAf+'</span><span style="font-size: 11px; text-transform: uppercase; display: block; float: left; margin-left: 20px; '+coloraforo+'">Aforo de la cola: '+eventAfcol+'</span></div></div></div>');
						...
						if (!fullendDate && startMonth == setMonth && startYear == setYear) {
							...
							//PREVALIDACION DNIS
							$('#'+uniqueId+' .monthly-list-item[data-number="'+startDay+'"]').addClass('item-has-event').append('<div class="listed-event"  data-eventid="'+ eventId +'" style="'+backgr+' border: 1px solid lightgray; border-radius: 7px; margin-left: auto; margin-right: auto; overflow: auto; padding-top: 0; width: 100%;"><div style="margin-top: 0px; overflow: auto; width: -moz-max-content; float: left;"><div id="contentActivity" style="margin-top: 0px; overflow: auto; width: -moz-max-content; float: left;"><span style="min-width: 165px; overflow: auto; margin-right: 14px; cursor: pointer; float: left; clear: both; display: block;">'+eventTitle+'</span><div style="overflow: auto; float: left; clear: left;"><div class="monthly-list-time-start">'+startTime+' '+startPeriod+'</div><div class="monthly-list-time-end">'+endTime+' '+endPeriod+'</div></div></div><div id="contentActions" style="overflow: auto; width: 400px; float: left;">'+cadaction+'<div id="contentPlazas" style="overflow: auto; width: 200px;"><span style="font-size: 11px; font-weight: 600; text-transform: uppercase; display: block; float: left; padding-top: 3px; margin-left: 20px; '+colordis+'">Plazas disponibles: '+eventDis+'</span><span style="font-size: 11px; font-weight: 600; text-transform: uppercase; display: block; float: left; margin-left: 20px; '+colorcola+'">Plazas en la cola: '+eventDisCol+'</span></div><div id="contentAforo" style="overflow: auto; width: 140px; float: left; margin-top: 1px;"><span style="font-size: 11px; text-transform: uppercase; padding-top: 2px; display: block; float: left; margin-left: 20px; '+coloraforo+'">Aforo: '+eventAf+'</span><span style="font-size: 11px; text-transform: uppercase; display: block; float: left; margin-left: 20px; '+coloraforo+'">Aforo de la cola: '+eventAfcol+'</span></div></div></div>');
