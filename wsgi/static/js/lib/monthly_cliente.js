				...
				$.get(''+options.xmlUrl+'', function(d){
					$(d).find('event').each(function(){
						...
						function multidaylist(){
							if(eventColor==''){
							    $('#'+uniqueId+' .monthly-list-item[data-number="'+i+'"]').addClass('item-has-event').append('<div class="listed-event"  data-eventid="'+ eventId +'" style="'+backgr+'padding-top:0px;"><span style="min-width: 165px; float: left; overflow: auto; margin-right: 14px;">'+eventTitle+'</span><div style="overflow:auto; width:400px;">'+cadaction+'<div style="overflow: auto; width: 200px; float: left;"><span style="font-size: 11px; font-weight: 600; text-transform: uppercase; display: block; float: left; padding-top: 3px; margin-left: 20px; '+colordis+'">Plazas disponibles: '+eventDis+'</span><span style="font-size: 11px; font-weight: 600; text-transform: uppercase; display: block; float: left; margin-left: 20px; '+colorcola+'">Plazas en la cola: '+eventDisCol+'</span></div><div style="overflow: auto; width: 140px; float: left; margin-top: 2px;"><span style="font-size: 11px; text-transform: uppercase; padding-top: 2px; display: block; float: left; margin-left: 20px; color: black;">Aforo: '+eventAf+'</span><span style="font-size: 11px; text-transform: uppercase; display: block; float: left; margin-left: 20px; color: black;">Aforo de la cola: '+eventAfcol+'</span></div></div><div style="width: auto; float: none; margin-top: -17px;"><div class="monthly-list-time-start">'+startTime+' '+startPeriod+'</div><div class="monthly-list-time-end">'+endTime+' '+endPeriod+'</div></div></div>');
							}
						...
						if (!fullendDate && startMonth == setMonth && startYear == setYear) {
							...
							//PREVALIDACION DNIS
							$('#'+uniqueId+' .monthly-list-item[data-number="'+startDay+'"]').addClass('item-has-event').append('<div class="listed-event" data-eventid="'+ eventId +'" style="padding-top:0px;"><span style="min-width: 165px; float: left; overflow: auto; margin-right: 14px;">'+eventTitle+'</span><div style="overflow:auto; width:400px;">'+cadaction+'<div style="overflow: auto; width: 200px; float: left;"><span style="font-size: 11px; font-weight: 600; text-transform: uppercase; display: block; float: left; padding-top: 3px; margin-left: 20px; '+colordis+'">Plazas disponibles: '+eventDis+'</span><span style="font-size: 11px; font-weight: 600; text-transform: uppercase; display: block; float: left; margin-left: 20px; '+colorcola+'">Plazas en la cola: '+eventDisCol+'</span></div><div style="overflow: auto; width: 140px; float: left; margin-top: 2px;"><span style="font-size: 11px; text-transform: uppercase; padding-top: 2px; display: block; float: left; margin-left: 20px; color: black;">Aforo: '+eventAf+'</span><span style="font-size: 11px; text-transform: uppercase; display: block; float: left; margin-left: 20px; color: black;">Aforo de la cola: '+eventAfcol+'</span></div></div><div style="width: auto; float: none; margin-top: -17px;"><div class="monthly-list-time-start">'+startTime+' '+startPeriod+'</div><div class="monthly-list-time-end">'+endTime+' '+endPeriod+'</div></div></div>');
