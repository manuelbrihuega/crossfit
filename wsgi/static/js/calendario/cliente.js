		...
		if(data.status=='success'){
			...
			for(var i=0; i<data.data.dias_a_mostrar; i++){
				...
				if(diasemana==5){
					...
					$('#'+idgen+'hour13').attr('style', 'width:auto; overflow:auto; background-color: #f2f2f2; border-left: 3px solid white; border-right: 3px solid white; border-top: 2px solid white;');
					$('#'+idgen+'hour14').attr('style', 'width:auto; overflow:auto; background-color: #f2f2f2; border-left: 3px solid white; border-right: 3px solid white;');
					$('#'+idgen+'hour15').attr('style', 'width:auto; overflow:auto; background-color: #f2f2f2; border-left: 3px solid white; border-right: 3px solid white;');
