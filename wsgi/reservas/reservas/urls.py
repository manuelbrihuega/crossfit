...
urlpatterns = patterns('',
    ...
    url(r'^api/login$', 'reservas.views.auth.login'),
    url(r'^api/logout$', 'reservas.views.auth.logout'),
    url(r'^api/status$', 'reservas.views.auth.status'),
    url(r'^api/restorepass$', 'reservas.views.auth.restorepass'),
    url(r'^api/add_tokenpush$', 'reservas.views.auth.add_tokenpush'),
    url(r'^api/del_tokenpush$', 'reservas.views.auth.del_tokenpush'),
    url(r'^api/edit_password$', 'reservas.views.auth.edit_password'),
    url(r'^api/get$', 'reservas.views.auth.get'),
    url(r'^api/get_user$', 'reservas.views.auth.get_user'),
    url(r'^api/tokin$', 'reservas.views.auth.tokin'),
    url(r'^api/ban$', 'reservas.views.auth.ban'),
    url(r'^api/unban$', 'reservas.views.auth.unban'),
    url(r'^api/activate$', 'reservas.views.auth.activate'),
    url(r'^api/deactivate$', 'reservas.views.auth.deactivate'),
    url(r'^api/list_roles$', 'reservas.views.auth.list_roles'),
    url(r'^api/search_by_email$', 'reservas.views.auth.search_by_email'),
    url(r'^api/get_otro_default$', 'reservas.views.auth.get_otro_default'),
    url(r'^api/get_oculto_default$', 'reservas.views.auth.get_oculto_default'),
    url(r'^api/get_taxista_default$', 'reservas.views.auth.get_taxista_default'),
    url(r'^api/search_by_phone$', 'reservas.views.auth.search_by_phone'),
    url(r'^api/send_instagram_by_phone$', 'reservas.views.auth.send_instagram_by_phone'),
    url(r'^api/warning_instagram$', 'reservas.views.auth.warning_instagram'),
    url(r'^api/list_num_users_by_year$', 'reservas.views.auth.list_num_users_by_year'),
