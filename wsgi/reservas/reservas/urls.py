...
urlpatterns = patterns('',
    ...
    url(r'^api/customers/get$', 'reservas.views.customers.get'),
    url(r'^api/customers/edit_foreign$', 'reservas.views.customers.edit_foreign'),
    url(r'^api/customers/edit_client$', 'reservas.views.customers.edit_client'),
    url(r'^api/customers/edit_photo$', 'reservas.views.customers.edit_photo'),
    url(r'^api/tarifas/list_all$', 'reservas.views.tarifas.list_all'),
    url(r'^api/customers/add$', 'reservas.views.customers.add'),
    url(r'^api/customers/pagar$', 'reservas.views.customers.pagar'),
    url(r'^api/customers/revertir_pago$', 'reservas.views.customers.revertir_pago'),
    url(r'^api/customers/add_super$', 'reservas.views.customers.add_super'),
    url(r'^api/customers/delete$', 'reservas.views.customers.delete'),
    url(r'^api/rates/list_all$', 'reservas.views.rates.list_all'),
    url(r'^api/rates/search$', 'reservas.views.rates.search'),
    url(r'^api/rates/add$', 'reservas.views.rates.add'),
    url(r'^api/rates/delete$', 'reservas.views.rates.delete'),
    url(r'^api/rates/get_foreign$', 'reservas.views.rates.get_foreign'),
    url(r'^api/rates/edit_foreign$', 'reservas.views.rates.edit_foreign'),
    url(r'^api/activities/edit_name$', 'reservas.views.activities.edit_name'),
    url(r'^api/schedules/edit_coach$', 'reservas.views.schedules.edit_coach'),
    url(r'^api/schedules/add_concrete$', 'reservas.views.schedules.add_concrete'),
    url(r'^api/schedules/rm_concrete$', 'reservas.views.schedules.rm_concrete'),
    url(r'^api/schedules/rm_interval$', 'reservas.views.schedules.rm_interval'),
    url(r'^api/schedules/add_party$', 'reservas.views.schedules.add_party'),
    url(r'^api/schedules/add_dni$', 'reservas.views.schedules.add_dni'),
    url(r'^api/schedules/add_interval$', 'reservas.views.schedules.add_interval'),
    url(r'^api/schedules/delete$', 'reservas.views.schedules.delete'),
    url(r'^api/schedules/delete_party$', 'reservas.views.schedules.delete_party'),
    url(r'^api/schedules/delete_dni$', 'reservas.views.schedules.delete_dni'),
    url(r'^api/schedules/delete_reservation$', 'reservas.views.schedules.delete_reservation'),
    url(r'^api/schedules/delete_reservation_client$', 'reservas.views.schedules.delete_reservation_client'),
    url(r'^api/schedules/list_all$', 'reservas.views.schedules.list_all'),
    url(r'^api/schedules/list_all_tabla$', 'reservas.views.schedules.list_all_tabla'),
    url(r'^api/schedules/list_all_tabla_for_customers$', 'reservas.views.schedules.list_all_tabla_for_customers'),
    url(r'^api/schedules/list_all_for_customers$', 'reservas.views.schedules.list_all_for_customers'),
    url(r'^api/schedules/list_parties$', 'reservas.views.schedules.list_parties'),
    url(r'^api/schedules/list_dnis$', 'reservas.views.schedules.list_dnis'),
    url(r'^api/schedules/get_foreign$', 'reservas.views.schedules.get_foreign'),
    url(r'^api/schedules/get_foreign_reservations_customer$', 'reservas.views.schedules.get_foreign_reservations_customer'),
    url(r'^api/schedules/get_reservations_customer$', 'reservas.views.schedules.get_reservations_customer'),
    url(r'^api/schedules/get_foreign_pagos_customer$', 'reservas.views.schedules.get_foreign_pagos_customer'),
    url(r'^api/schedules/hay_plazas$', 'reservas.views.schedules.hay_plazas'),
    url(r'^api/schedules/edit_config$', 'reservas.views.schedules.edit_config'),
    url(r'^api/schedules/edit_config_email$', 'reservas.views.schedules.edit_config_email'),
    url(r'^api/schedules/get_configuration$', 'reservas.views.schedules.get_configuration'),
    url(r'^api/schedules/add_reservation$', 'reservas.views.schedules.add_reservation'),
    url(r'^api/schedules/add_reservation_client$', 'reservas.views.schedules.add_reservation_client'),
    url(r'^api/news/add_global_news$', 'reservas.views.news.add_global_news'),
    url(r'^api/news/list_news_foreign$', 'reservas.views.news.list_news_foreign'),
    url(r'^api/news/delete$', 'reservas.views.news.delete'),
    url(r'^api/news/list_news$', 'reservas.views.news.list_news'),
    url(r'^api/activities/list_all$', 'reservas.views.activities.list_all'),
    url(r'^api/activities/search$', 'reservas.views.activities.search'),
    url(r'^api/activities/add$', 'reservas.views.activities.add'),
    url(r'^api/activities/delete$', 'reservas.views.activities.delete'),
    url(r'^api/activities/get_foreign$', 'reservas.views.activities.get_foreign'),
    url(r'^api/activities/edit_foreign$', 'reservas.views.activities.edit_foreign'),
    ...
    url(r'^api/tickets/add$', 'reservas.views.tickets.add'),
    url(r'^api/tickets/list_all$', 'reservas.views.tickets.list_all'),
    url(r'^api/tickets/list_opened$', 'reservas.views.tickets.list_opened'),
    url(r'^api/tickets/list_messages$', 'reservas.views.tickets.list_messages'),
    url(r'^api/tickets/close$', 'reservas.views.tickets.close'),
    url(r'^api/tickets/respond$', 'reservas.views.tickets.respond'),
    url(r'^api/tickets/notifications$', 'reservas.views.tickets.notifications'),
    url(r'^api/tickets/list_foreign$', 'reservas.views.tickets.list_foreign'),
    url(r'^api/tickets/respond_foreign$', 'reservas.views.tickets.respond_foreign'),
    url(r'^api/tickets/notifications_supporters$', 'reservas.views.tickets.notifications_supporters'),
    url(r'^api/tickets/hide$', 'reservas.views.tickets.hide'),
    ...
    url(r'^perfil$', 'reservas.views.dashboard.perfil'),
    url(r'^historial$', 'reservas.views.dashboard.historial'),
    url(r'^configuracion$', 'reservas.views.dashboard.configuracion'),
    ...
    url(r'^partials/tarifas_super$', 'reservas.views.partials.tarifas_super'),
    url(r'^partials/calendario_super$', 'reservas.views.partials.calendario_super'),
    url(r'^partials/calendario_cliente$', 'reservas.views.partials.calendario_cliente'),
    url(r'^partials/actividades_super$', 'reservas.views.partials.actividades_super'),
    ...
    url(r'^partials/perfil_clientes$', 'reservas.views.partials.perfil_clientes'),
    url(r'^partials/historial_clientes$', 'reservas.views.partials.historial_clientes'),
    url(r'^partials/configuracion_super$', 'reservas.views.partials.configuracion_super'),
    ...
    url(r'^partials/modal_tarifa_details$', 'reservas.views.partials.modal_tarifa_details'),
    url(r'^partials/modal_actividad_details$', 'reservas.views.partials.modal_actividad_details'),
    url(r'^partials/modal_calendario_details$', 'reservas.views.partials.modal_calendario_details'),
    ...
    url(r'^partials/cookies$', 'reservas.views.partials.cookies'),
