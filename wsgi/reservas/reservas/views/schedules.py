...
def list_all_tabla(request):
    ...
    try:
        ...
        schedule_time=Schedules_times.objects.filter(Q(schedule__concrete=1), Q(schedule__date__gte=hoy), Q(schedule__date_lte=next)).order_by('-schedule__activity__name')
