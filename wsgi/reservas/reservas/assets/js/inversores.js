...
function restoreNav () {
    if($(window).width()>=768) $('#nav').fadeIn(); 
}

function openWindow(ruta){
     window.open(ruta,"Ventana: Taxible"); 
}

function popupLegal(url) {
    var win = window.open(url, 'InformacionLegal', 'resizable=yes,height=400,width=700,scrollbars=1');
 	return false;
}
